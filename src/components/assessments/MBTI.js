/*--------------------------------------
    ...
    state: {
      view: ["assessing", "submitting", "resetting", "scoring", "presenting"],
      activeQuestion: Int + 1
      questions: [
        {
          text: "..."
          options: [["value", "option"], ["value", "option"], ...]
          answered: Bool
          answeredIndex: the index of the option that was chosen (I think I need this for display purposes if I want to enable "back" behavior)
        }
      ]
